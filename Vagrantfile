...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "consul-node-1" do |r1|
    r1.vm.network "public_network", ip: "192.168.1.201", bridge: "#$default_if"
  end

  config.vm.define "consul-node-2" do |r2|
    r2.vm.network "public_network", ip: "192.168.1.202", bridge: "#$default_if"
  end

  config.vm.define "consul-node-3" do |r3|
    r3.vm.network "public_network", ip: "192.168.1.203", bridge: "#$default_if"
  end
